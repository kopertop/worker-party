...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/worker-party)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/worker-party
```

A live public deployment of this template is available at [https://worker-party.templates.workers.dev](https://worker-party.templates.workers.dev)
